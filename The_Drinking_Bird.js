...
function createHead() {
   ...
   var cylinderMaterial = new THREE.MeshLambertMaterial( { color: 0x0000D0 } );
    ...
    hatU.position.y = 160+390+40+10 + 70/2;
    hatL = new THREE.Mesh (
        new THREE.CylinderGeometry(142/2, 142/2, 10, 32), cylinderMaterial)
    hatL.position.y = 160+390+40 + 10/2;
    scene.add(hatU);
    scene.add(hatL);
}
...
function render() {
	...
	if ( effectController.newGridX !== gridX || effectController.newGridY 
!== gridY || effectController.newGridZ !== gridZ || effectController.newGround 
!== ground || effectController.newAxes !== axes)
	{
...
draw on canvas. Error was:<br/><br/>";
